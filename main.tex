...
scaffolded. However, the same body of work consistently notes that commercially
available chatbots are not designed for instruction. OpenAI's GPT-4 technical
report (2023) and Anthropic's writing on Constitutional AI (2024) both describe
their models as optimized for general helpfulness rather than pedagogical
clarity. Pew Research (2024) confirmed rapid adoption of these tools by students
but warned that AI's educational usefulness is limited by inconsistent accuracy
and a lack of transparent reasoning. Dwivedi et al.\ (2023) argue that LLMs
produce outputs that are syntactically fluent but epistemically unreliable when
used for learning.
...
at once. Explanations that are long, dense, or poorly organized increase
extraneous load---cognitive effort that does not contribute to learning. Later
refinements (Kalyuga, 2009; Paas \& van Merri\"enboer, 2020) emphasize that
effective explanations are concise, sequenced, and chunked. Chi and Wylie's
ICAP framework (2014) extends this with a taxonomy of learner engagement,
finding that explanations which prompt active construction outperform passive
ones.

For an AI explanation system, format matters. An explanation segmented into
definition, worked example, analogy, and application is structurally easier to
encode than a free-flowing paragraph. SimplrAI's output schema is designed
around precisely this finding.

% TODO: hallucination section
% TODO: reading level / UX section
% TODO: synthesis / gaps
